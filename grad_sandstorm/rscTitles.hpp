...
class grad_sandstormTime {
    ...
    class ControlsBackground {
        class Countdown {
            onLoad = "uiNamespace setVariable ['grad_sandstormTime', _this select 0];";
            onUnload = "uiNamespace setVariable ['grad_sandstormTime', controlNull];";
